...
public class BucketTest {
	...
	public void testCompare() {
		Bucket b = BucketBuilders.createFromQueryString("corn production", Arrays.asList("corn", "production"), new HashSet<String>());
		Bucket b1 = BucketBuilders.createFromQueryString("corn production", Arrays.asList("corn production"), new HashSet<String>());
