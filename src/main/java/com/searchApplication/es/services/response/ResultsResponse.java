											...
											&& bucket.getAggregations().get("dbproperties") != null )
									{
										...
										for( Terms.Bucket bucket1 : buckets1 )
										{
											...
											for( Terms.Bucket bucket3 : buckets.getBuckets() )
											{
												...
												Terms locationTypeBuckets = bucket3.getAggregations()
														.get("locationType");
												boolean add = true;
												for( Terms.Bucket locationTypeBucket : locationTypeBuckets
														.getBuckets() )
												{
													Terms locationNameBuckets = locationTypeBucket.getAggregations()
															.get("locationname");
